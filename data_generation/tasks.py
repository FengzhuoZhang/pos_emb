...
def get_task_sampler(
    task_name, n_dims, batch_size, zero_pad = True, pool_dict=None, num_tasks=None, **kwargs
):
    ...
    if task_name in task_names_to_classes:
        ...
        return lambda **args: task_cls(n_dims, batch_size, zero_pad, pool_dict, **args, **kwargs)
    else:
        print("Unknown task")
        raise NotImplementedError
...
class LinearRegression(Task):
    def __init__(self, n_dims, batch_size, zero_pad = True, pool_dict=None, seeds=None, scale=1):
        ...
        if self.zero_pad:
            zeros = torch.zeros(self.w_b.shape[0],1,1)
            self.w_b = torch.cat([self.w_b,zeros],dim =1 )
